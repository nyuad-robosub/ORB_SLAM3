...
public:
    MyClass() : it_(nh_), orig_image_sub_(it_, "image/orig", 1), warp_image_sub_(it_, "image/warp", 1), sync(MySyncPolicy(10), orig_image_sub_, warp_image_sub_)
    {
    ...
    void callback(
        ...
        const sensor_msgs::ImageConstPtr &disparity)
    {
        // your code here
    }
...
int main(int argc, char *argv[])
{
    ...
    sync.registerCallback(boost::bind(&MyClass::callback, this, _1, _2));
    // ImageSubscriber sub = it.subscribe("camera/image", 1, imageCallback);
